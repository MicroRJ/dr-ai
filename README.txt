A small 2 layer AI that can learn to recognize digits with over 90% accuracy.
All the algorithm does at the moment is one pass over 80% percent of the samples (10% for testing).
Speed-wise, it can analyze well over 60,000 28 by 28 image samples in less than half a second, whether
